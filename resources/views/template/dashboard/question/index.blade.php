 ...
 <div class="page-wrapper">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-12 bg-white p-3">
            ...
            <a class="btn btn-success border rounded mb-2 text-white" href=" {{ route('question.create') }} ">
                Add Question +
            </a> 
            ...
            <table id="myTable" class="table table-responsive-sm table-striped table-bordered">
                <thead class="table-dark text-white">
                    ...
                    <th scope="col" class="text-white">A</th>
                    <th scope="col" class="text-white">B</th>
                    <th scope="col" class="text-white">C</th>
                    <th scope="col" class="text-white">D</th>
